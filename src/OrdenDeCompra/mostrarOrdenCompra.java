 ...
 * @author laloh
 */
public class mostrarOrdenCompra extends javax.swing.JFrame {

    /**
     * Creates new form mostrarOrdenCompra
     */
    public mostrarOrdenCompra() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mostrarOrdenCompra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mostrarOrdenCompra().setVisible(true);
            }
        });
    }
