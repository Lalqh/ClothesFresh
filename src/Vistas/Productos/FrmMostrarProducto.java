...
public class FrmMostrarProducto extends javax.swing.JInternalFrame {
    ...
    public FrmMostrarProducto(ListaProductos listaP, ListaCategorias listaC) {
        initComponents();
        this.listaP = listaP;
        this.listac = listaC;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       int id = Integer.parseInt(JOptionPane.showInputDialog(null, "Ingresa el ID del producto a eliminar"));
       listaP.eliminarNodo(id);
